(function(window){
  ...
  if ((window.tagboard && typeof window.tagboard === 'string') || (window.tagboardOptions && window.tagboardOptions.tagboard)) {
    ...
    if (window.tagboard) {
      ...
      con.error("Using deprecated version of Tagboard embed. Update embed code. https://help.tagboard.com/en/articles/3112799-embedding-a-tagboard");
    } else {
      tagboardOptions.version = 2;
      con.warn("Using an out-of-date version of Tagboard embed. Please update embed code. https://help.tagboard.com/en/articles/3112799-embedding-a-tagboard");
    }
